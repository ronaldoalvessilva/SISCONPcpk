...
import static br.com.sisconpcpk.visao.TelaTrocaSenha.jConfirmaSenhaCPK;
import static br.com.sisconpcpk.visao.TelaTrocaSenha.jNovaSenhaCPK;
import java.io.File;
...
public class TelaAvisoMensagemTrocaSenha extends javax.swing.JDialog {
    ...
    public void pesquisaGlobal() {
        ...
        if (arqLF.exists()) {
            ...
            objUser.setSenha1(jNovaSenhaCPK.getText());
            objUser.setSenha2(jConfirmaSenhaCPK.getText());
