...
import br.com.sisconpcpk.dao.ControleBiometriaInternos;
import br.com.sisconpcpk.modelo.BiometriaInternos;
...
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.caminhoFotoInternoTRIAGEMCkp;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoAnularDireito;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoAnularEsquerdo;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoIndicadorDireito;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoIndicadorEsquerdo;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoMedioDireito;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoMedioEsquerdo;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoMinimoEsquerdo;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoMininoDireito;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoPolegarDireito;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jFotoPolegarEsquerdo;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jIdInternoCkp;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jMatriculaPenalCkp;
import static br.com.sisconpcpk.visao.TelaCadastroDatiloscopia.jNomeInternoCpk;
 ...
 * @author ronaldo
 */
public class TelaBiometriaInternoCkp extends javax.swing.JDialog {
    ...
    public static TelaCadastroDatiloscopia prontuarioTriagem;

    /**
     * Creates new form TelaBiometriaInterno
     */
    public TelaBiometriaInternoCkp(TelaCadastroDatiloscopia parent, boolean modal) {
        ...
        // CARREGAR IMAGEM NO CANTO SUPERIOIR ESQUERDO DA TELA
        URL url = this.getClass().getResource("/br/com/sisconpcpk/imagens/Biometria16Vermelho.png");
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jComboBoxOpcao.getSelectedItem().equals("Selecione...")) {
            ...
            try {
                ...
                Logger.getLogger(TelaBiometriaInternoCkp.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBiometriaInternoCkp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBiometriaInternoCkp dialog = new TelaBiometriaInternoCkp(prontuarioTriagem, true);
    ...
    public void dadosInterno() {
        javax.swing.ImageIcon z = new javax.swing.ImageIcon(caminhoFotoInternoTRIAGEMCkp);
        ...
        jCodigoInterno.setText(jIdInternoCkp.getText());
        jNomeInternoCrc.setText(jNomeInternoCpk.getText());
        jMatriculaPenalBio.setText(jMatriculaPenalCkp.getText());
    }
