...
public class TelaFotoCrc extends javax.swing.JDialog {
    ...
    public static TelaConfereInternos telaConfere;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoCrc(TelaConfereInternos parent, boolean modal) {
        this.telaConfere = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaConfere);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoCrc dialog = new TelaFotoCrc(telaConfere, true);
