...
import br.com.sisconpcpk.visao.*;
 ...
 * @author ronaldo
 */
public class TelaBiometriaKitInternoCPK_BKP extends javax.swing.JDialog {
    ...
    public TelaBiometriaKitInternoCPK_BKP(TelaPagamentoKitInternoCPK parent, boolean modal) {
...
//        pesquisarProdutoKitInterno();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBiometriaKitInternoCPK_BKP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBiometriaKitInternoCPK_BKP dialog = new TelaBiometriaKitInternoCPK_BKP(pagamentoKit, true);
