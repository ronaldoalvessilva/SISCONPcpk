...
import static br.com.sisconpcpk.visao.TelaPagamentoKitInternoCPK.idItem;
import static br.com.sisconpcpk.visao.TelaPagamentoKitInternoCPK.jDataEntrega;
import static br.com.sisconpcpk.visao.TelaPagamentoKitInternoCPK.jFotoInternoKit;
import static br.com.sisconpcpk.visao.TelaPagamentoKitInternoCPK.jHorarioPagto;
 ...
 * @author ronal
 */
public class TelaPesquisaInternoKitPago extends javax.swing.JDialog {
     ...
     */
    public static TelaPagamentoKitInternoCPK pPAGTO_KIT;

    public TelaPesquisaInternoKitPago(TelaPagamentoKitInternoCPK parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jBtPesquisaNome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sisconpcpk/imagens/Lupas_1338_05_1.gif"))); // NOI18N
        ...
        jBtPesquisaMatricula.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sisconpcpk/imagens/Lupas_1338_05_1.gif"))); // NOI18N
        ...
        jTabelaPesquisaInternos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Pagto", "Código", "Matricula", "Nome do Interno"
            }
        ));
        ...
        jBtConfirmar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sisconpcpk/imagens/40_16x16.png"))); // NOI18N
    ...
    private void jBtPesquisaMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisaMatriculaActionPerformed
        ...
        if (jMatriculaPesquisa.getText().equals("")) {
            ...
            preencherTabelaInternos("SELECT ITENS_PAGAMENTO_KIT_INTERNOS.IdInternoCrc, "
                    + "ITENS_PAGAMENTO_KIT_INTERNOS.IdPagto,ITENS_PAGAMENTO_KIT_INTERNOS.IdItem, "
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        flag = 1;
        if (flag == 1) {
            String pITEM_KIT = "" + jTabelaPesquisaInternos.getValueAt(jTabelaPesquisaInternos.getSelectedRow(), 0);
            //
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaInternoKitPago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPesquisaInternoKitPago dialog = new TelaPesquisaInternoKitPago(pPAGTO_KIT, true);
    ...
    public void preencherTabelaInternos(String sql) {
        ...
        String[] Colunas = new String[]{"Item", "Pagto", "Código", "Matricula", "Nome do Interno"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getString("IdItem"), conecta.rs.getString("IdPagto"), conecta.rs.getString("IdInternoCrc"), conecta.rs.getString("MatriculaCrc"), conecta.rs.getString("NomeInternoCrc")});
