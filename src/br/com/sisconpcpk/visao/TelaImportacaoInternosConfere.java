...
public class TelaImportacaoInternosConfere extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("...::: Importa Cadastro de Internos e Locação :::...");
        ...
        jTabelaInternos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "CNC", "Nome do Interno", "Title 4"
            }
        ));
    ...
    public void mostraSelecaoInternos() {
        ...
        try {
            for (GravarInternos dd : control.read()) {
                ...
                dadosOrigem.addRow(new Object[]{dd.getIdInternoCrc(), dd.getcNcinterno(), dd.getNomeInternoCrc()});
...
//                        objGravaIntComp.setIdRegistroComp(Integer.valueOf(jIdRegistroComp.getText()));// TABELA PRINCIPAL (COMPOSICAO_PAGAMENTO_KIT_INTERNOS_LOTE)                                                        
                        objGravaIntComp.setIdInternoCrc((int) jTabelaInternos.getValueAt(i, 0));
                        objGravaIntComp.setNomeInternoCrc((String) jTabelaInternos.getValueAt(i, 1));
