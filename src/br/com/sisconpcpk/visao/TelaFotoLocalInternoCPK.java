 ...
 * @author ronaldo
 */
public class TelaFotoLocalInternoCPK extends javax.swing.JDialog {

    ConectaBanco conecta = new ConectaBanco();

    String caminhoFoto;

    public static TelaConsultaLocalInternoSegurancaCPK telaLocalInterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocalInternoCPK(TelaConsultaLocalInternoSegurancaCPK parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocalInternoCPK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocalInternoCPK dialog = new TelaFotoLocalInternoCPK(telaLocalInterno, true);
